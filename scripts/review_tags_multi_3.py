...
def get_review_details(attribute_seed, attribute_adjective_map, sent):
    try:
        ...
        if path_with_score == None or path_with_score == []:
            print('path is none for line: ', sent)
            return None
        ...
        print ('Type Error in attribute_adjective_finder for line: ', sent)
        return None
...
#        return None
        ...
        if address != None and address != []:
            if address['street'] != '' and address['street'] != None:
                ...
                if geocode_result == None or len(geocode_result) == 0:
                    print ('geo code not found for street address: ' , street_address)
                else:
                    location = {}
    ...
    print ('elastic_count, review_count: %s ; %s', elastic_count, review_count)
    elastic_count += 1
    review_count += 1
...
if __name__ == "__main__":
    ...
    if len(sys.argv) == 1:
        ...
        while user_input != 'stop':
            ...
            print ('elastic obj: ', formed_object)
            user_input = raw_input("Some input please: ")
    else:
        ...
        for city_id in meta_review_data:
            ...
            for val in review_data:
                ...
                try: 
                    ...
                    print (type(city_id))
                    print (type(hotel_id))
                    print ('type error: %s ; %s', city_id.encode('utf-8'), hotel_id)
