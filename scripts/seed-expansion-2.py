...
#def findNextBest(tag, node, path, isRoot):
#    #node['keywords'][tag] = 1
#    max_distance = -1
#    min_distance = 0.3
#    max_node = None
...
#        dist = findMaxAvgDistance(tag, node['next'][inner]['keywords'])
#        #print 'distance: ' + str(dist)
#        if dist == -1:
#            return
#        if isRoot and dist < min_distance:
#            max_node = 'others'
#        else:
...
#    #print 'checkout add tag & distance & max_node: ' + tag + ' ; ' + str(max_distance) + ' ; ' + max_node
#    winner_node = node['next'][max_node]
#    if max_node == 'others':
#        winner_node['keywords']['tag'] = 1
#    else:
#        winner_node['keywords']['tag'] = 1
#    findNextBest(tag, winner_node, path, False)
...
if __name__ == "__main__":
    ...
    f = open('data/expanded-seed.json', 'w')
